...
import { isValidTargetConnection } from './CtUtils'
...
.vue-flow__node-ct-output.selected {
  box-shadow: 0 0 0 2px var(--ct-vue-flow-node-selected-color);
}

.vue-flow__node-ct-output .vue-flow__handle {
  height: 24px;
  width: 10px;
  border-radius: 4px;
}

.vue-flow__node-ct-output .unit-input-container {
  width: 100%;
}

.vue-flow__node-ct-output .vue-flow__handle-target {
